...
namespace jetfuel {
    namespace gui {
        ...
        ///
        /// A checkbox object that is exactly what it sounds like.
        /// A box that can or cannot be checked from mouse clicks.
        /// (What did you expect?)
        ///
        /// Code Example:
        ...
        ///     jetfuel::draw::Image activecheckboximage("checkboxchecked.png",
        ///                                      		 &scenemanager);
        ///     jetfuel::draw::Image disabledcheckboximage("checkbox.png",
        ///                                      		   &scenemanager);
        ...
        ///
        ///     if(!scenemanager.Create_window("Hello Checkboxes!",
        ...
        ///     scene1.Attach_drawable(&checkbox,1);
        ///
        ///     if(!checkbox.Load_check_box_images(backgroundimage)){
        ///         std::cerr << "[!]ERROR with loading from image! Error is:" <<
        ///         IMG_GetError() << "\n";
        ///     }
        ///
        ///     checkbox.Set_position(jetfuel::draw::Vector2d_int(0,0));
        ///
