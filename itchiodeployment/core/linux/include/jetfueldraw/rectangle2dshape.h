    ...
    namespace draw {
        ...
        public:
            ...
            void Set_size(const Vector2d_int size){
                m_recttodraw = Rect2d_int(m_recttodraw.x,m_recttodraw.y,
                                          size.x,size.y);
            }
            ...
            void Set_position(const Vector2d_int position)override{
                m_recttodraw = Rect2d_int(position.x,position.y,
                                          m_recttodraw.width,
                                          m_recttodraw.height);
            }
        ...
        private:
            ...
            Rect2d_int m_recttodraw; ///< rectangle to draw Rect2d_int
