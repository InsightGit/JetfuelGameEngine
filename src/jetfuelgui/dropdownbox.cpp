...
namespace jetfuel {
    namespace gui {
        void Drop_down_box::Add_option(const std::string option){
        	// If first option, then set it as the base box option.
        	// If not, generate the option box and text to be shown
        	// when active.
            ...
            // Stores option in m_options vector.
        ...
        void Drop_down_box::Check_for_clicks(jetfuel::control::Action
                                             UISinterpreterdata){
        	// If not active when clicked, then it becomes active.
        	// If active when clicked, find option which was
        	// clicked (if any), then set it as not active.
        ...
        bool Drop_down_box::Draw(){
        	// If needed, Dynamically load the base box's image,
        	// and then draw it as well as the option boxes if active.
